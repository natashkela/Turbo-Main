          ...
          {relatedPosts.map((post,index)=>
            <div key={index} className="col-md-4">
              <a href="#">
                ...
                style={{backgroundImage:`url(${require("../../../assets/img/post-single/related-post"+post.id+".jpg")})`, backgroundSize: 'cover',backgroundPosition: 'top center', backgroundRepeat: 'no-repeat'}}>
