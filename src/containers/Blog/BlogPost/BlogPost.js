...
import BlogPostInformation from '../../../components/Blog/BlogPost/BlogPostInformation';
import BlogPostShare from '../../../components/Blog/BlogPost/BlogPostShare';
import RelatedPosts from '../../../components/Blog/BlogPost/RelatedPosts';
import BlogPostComments from '../../../components/Blog/BlogPost/BlogPostComments/BlogPostComments.js';
        ...
        <div className="rq-page-content">
          <div className="blog-post-single-wrapper">
            <div className="signle-post-feature-img">
              <img src={require("../../../assets/img/post-single/image-post.jpg")} alt="" />
            </div>
